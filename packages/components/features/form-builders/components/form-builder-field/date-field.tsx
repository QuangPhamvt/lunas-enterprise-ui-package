...
import type { formBuilderDateFieldSchema } from '../../schema';
...
const FieldType: React.FC = () => {
  const {
    ...
    handleChange,
  } = useFormBuilderFieldContext<z.infer<typeof formBuilderDateFieldSchema>>();
...
export const FormBuilderDateField: React.FC<{
  ...
  const { state } = useFormBuilderFieldContext<z.infer<typeof formBuilderDateFieldSchema>>();
  return (
    <FormBuilderFieldWrapper>
      <FormBuilderFieldTrigger>
        <FieldSet>
