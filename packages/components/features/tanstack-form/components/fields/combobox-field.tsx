...
export const ComboboxField = memo<ComboboxFieldProps>(({
  ...
  const commandList = (
    <Command className="border-none">
      ...
      <CommandList>
        <CommandEmpty className="flex min-h-30 items-center justify-center text-sm text-text-positive-weak">
      ...
      <Field orientation={orientation} data-invalid={_invalid}>
        ...
        <FieldContentMain className="flex justify-end">
          <div className="flex w-full flex-col">
            ...
            {_touched && showErrorMessage && (
              <FieldError id={errorId} className="mt-1" errors={field.state.meta.errors} />
            )}
